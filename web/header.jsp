<%-- 
    Document   : header
    Created on : Jul 15, 2022, 8:59:28 PM
    Author     : Hung
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="BookshelvesController">Book Shelves</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="ReserveOrderController">Reserved Books</a>
                    </li>
                    <li class="nav-item">
